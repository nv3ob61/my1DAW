...
public class UtilesValidacion {
  ...
  //Nontiendo por qué no coje el regex con acentos y en el expresionator sí...
  public static final String REG_DENOM = "[a-zA-ZñÑ áéíóúÁÉÍÓÚüÜ.,]{1,50}";
  public static final String REG_DOMI = "[a-zA-Z0-9ªºñÑ áéíóúÁÉÍÓÚüÜ.,()]{1,50}";
  ...
  public static final boolean validaDomicilio(String domi) {
    return validar(domi, REG_DOMI);
  }
}
