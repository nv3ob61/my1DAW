...
public class Neumatico implements INeumatico {
  ...
  public Neumatico() {
    presion = UtilesVehiculo.DEF_PRESION;
    color = UtilesVehiculo.DEF_COLOR;
    diametro = UtilesVehiculo.DEF_DIAMETRO;
    tipoNeumatico = UtilesVehiculo.DEF_TIPONEUM;
    estadoNeumatico = UtilesVehiculo.DEF_ESTADONEUM;
  }
