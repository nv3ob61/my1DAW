...
public class UtilesPrimitivos {
    ...
    ********************************************************************** */
    ...
    public final static void operarRaiz(double valorA, double valorB,
            double valorC) {
        double disc;
        double resultadoX1;
        double resultadoX2;

        disc = Math.pow(valorB, 2) - (4 * valorA * valorC);
        //Si los tres valores son 0
        if (valorA == 0 && valorB == 0 && valorC == 0) {
            System.out.println(PACO);
            System.out.println("X puede ser cualquier valor.");
        ...
        //Si solo A es 0
            ...
            resultadoX1 = -valorC / valorB;
            System.out.println(PACO);
            System.out.println("Resultado: X1 == X2 " + resultadoX1);
            System.out.println(PACO_LONG);
        //Si el discriminante es mayor que 0
        } else if (disc > 0.0) {
            resultadoX1 = (-valorB + Math.sqrt(disc)) / (2 * valorA);
            resultadoX2 = (-valorB - Math.sqrt(disc)) / (2 * valorA);
            System.out.println(PACO);
            System.out.println("Resultado: X1 = " + resultadoX1 + "; X2 = " + resultadoX2);
            System.out.println(PACO_LONG);
        //Si el discriminante es 0
        } else if (disc == 0.0) {
            resultadoX1 = -valorB / (2 * valorA);
            System.out.println(PACO);
            System.out.println("Raices iguales: X1 == X2 " + resultadoX1);
            System.out.println(PACO_LONG);
